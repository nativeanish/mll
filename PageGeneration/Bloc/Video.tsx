...
function ProviderMark({ provider }: { provider: VideoProvider }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-white/90 px-2 py-1 text-[11px] font-semibold text-gray-800 ring-1 ring-inset ring-black/5 backdrop-blur">
        ...
        {normalizedUrl ? (
          <div className="px-4 py-3 border-t border-gray-100 flex items-center gap-3">
            <a
              ...
              className="min-w-0 flex-1 text-xs text-gray-500 truncate hover:text-gray-700"
              title={normalizedUrl}
            >
            ...
            <a
              ...
              rel="noopener"
              referrerPolicy="origin"
              className="shrink-0 inline-flex items-center gap-2 rounded-lg bg-gray-900 px-3 py-2 text-xs font-semibold text-white hover:bg-black transition-colors"
            >
              <LinkIcon size={16} />
              Open
            </a>
